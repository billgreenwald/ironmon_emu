...
android {
    ...
    buildTypes {
        debug {
            ...
            // Allows the Ironmon Tracker app to read GBA memory over localhost:7777.
            externalNativeBuild {
                cmake {
                    arguments += "-DMEMAPI_ENABLE=ON"
                }
            }
        }
        release {
            ...
            // MEMAPI_ENABLE intentionally absent — server code not compiled in release
        }
    }
    compileOptions {
